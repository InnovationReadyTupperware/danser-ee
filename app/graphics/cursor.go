...
type Cursor struct {
	...
	IsAutoplay    bool
	IsReplay      bool
	// IsCursorDance identifies a cursor whose movement was generated by the
	// cursor-dance controller. It is intentionally separate from IsAutoplay:
	// the spinner HUD may use a generated cursor's exact target RPM, but must
	// continue measuring ordinary autoplay or replay input from rotation.
	IsCursorDance bool
